...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statistics = __webpack_require__(196);
	...
	var _cookies = __webpack_require__(199);
	...
	*/
	...
	var log = LOG_ENABLE ? function (log) {
		console.log(log);
	} : function () {};
	...
	var SpiceJS = window.SpiceJS = Object.create({
		...
		init: function init() {
			...
			var time = this.TimeToBuild = new Date().getTime();
						...
						prototype: {
							...
							loop: function loop(a) {
								...
								var loop = function loop() {
									...
									_this4.resized = _this4.update.size(_this4);

									//Draw frame
									_this4.visuals.flip(_this4.scale);

									//Update scale
									_this4.scale = _this4.update.scale(_this4);

									//Update frames per second
									_this4.fps = _this4.update.step.tick(_this4.second, _this4.mainLoop, _this4.app);

									//Update client
									requestAnimationFrame(_this4.client_f);
								};
							...
							visuals: {
								...
								prototype: {
									...
									debug: function debug() {
										...
										if (App.fps < 20) log("FPSLow: " + App.fps);
									...
									circle: function circle(x, y, r, col, a) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = (function (_SJSClass) {
			...
			function Loader(app) {
					...
					var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Loader).call(this, app));

					_this2.ImageCache = [];

					_this2.ImageBuffer = [];

					_this2.ImageBufferTime = 3;
